<!-------------------------------------------------------------- 
Filename: FE/src/lib/components/CodeAndTags.svelte
...
<script lang="ts">
    export let exercises_counts: {flashcards: number, quizes: number, readings: number, all: number};
</script>

<!-- TODO kod -->
<!-- TODO dalsi tagy (?) --> 
<!-- TODO obnovovani pocitadla --> 
