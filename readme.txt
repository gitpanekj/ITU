...
`FE/src/routes/teacher/module/[routeModuleId]/flashcards/[routeFlashcardExerciseId]/+page.svelte`, využívá komponenty `Feedback` a `QuestionList`, které jsou umístěny v adresáři `FE/src/lib/components/flashcards`
